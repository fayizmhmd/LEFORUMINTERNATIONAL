...
@endsection
@section('content')
<form action="{{ route('admin.updateColleges',$colleges->id) }}" method="POST" id="myForm" enctype="multipart/form-data">
    @csrf
        ...
        <div class='form-group row mb-4 align-middle'>
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" value="{{ $colleges->rating }}" placeholder="Rating" name='rating'
                    required />
            </div>
        </div>
        <div class='form-group row mb-4 align-middle'>
        ...
        <div class='form-group row mb-4 align-middle'>
            ...
            <div class="col-lg-9">
                <textarea class="form-control" value="{{ $colleges->description }}" name="summernote" id="summernote" cols="30" rows="10">
        ...
        <div class='form-group row mb-4 align-middle'>
            ...
            <div class="col-lg-9">
                <input type="file" class="form-control" placeholder="Browse image" name='images[]' multiple required />
            </div>
                    ...
                    @if ($colleges->image)
                        @foreach (json_decode($colleges->image) as $image)
                            <div class="col-md-4 mb-2">
                                <img src="{{ asset($image) }}" class="img-thumbnail" alt="" style="max-width: 100%; height: 100px; display: block; margin-left: auto; margin-right: auto;">
                            </div>
                        @endforeach
                    @endif
                </div>
        ...
        <div class='form-group row mb-4 align-middle'>
            ...
            <div class="col-lg-9">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="type" id="university" value="2" {{ $colleges->type == 2 ? 'checked' : '' }}>
                    <label class="form-check-label" for="university">University</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="type" id="college" value="1" {{ $colleges->type == 1 ? 'checked' : '' }}>
