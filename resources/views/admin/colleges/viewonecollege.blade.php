...
<head>
    ...
    <title>Explore Universities and Colleges</title>
    @php
        $path = asset('/');
    @endphp
    ...
    <link rel="stylesheet" href="{{ $path }}newfront/vendors/air-datepicker/css/datepicker.min.css">
    <link rel="stylesheet" href="{{ $path }}newfront/vendors/jquery-ui/jquery-ui.min.css">
...
<body>
    ...
    <div id="site-wrapper" class="site-wrapper explore-details explore-details-full-gallery">
                ...
                <div class="container container-1720">
                    <nav class="navbar navbar-expand-xl">
                        <div
                            ...
                            <h4>
                                <span class="main-heading-color" style="display: block">Colleges</span>
                                <span class="font-weight-light ">Bangalore </span>
                            </h4>
                        </div>
                        <div class="collapse navbar-collapse" id="navbar-main-menu">
                            <h2 class="for-mobile-view">
                                <span class="main-heading-color">Colleges</span>
                                <span class="font-weight-light ">Bangalore
                                </span>
                            </h2>
                            <ul class="navbar-nav">
                                <li class="nav-item">
        ...
        <div id="wrapper-content" class="wrapper-content pb-0 pt-0">
            <div class="image-gallery">
                ...
                @foreach (json_decode($college->image, true) as $img)
                <div class="box"><img src="{{ $path . $img }}" alt="Gallery-img"></div>
                @endforeach
                    {{-- <div class="box"><img src="{{ $path . $college->image }}" alt="Gallery 01"></div>
                    <div class="box center"><img src="{{ $path . $college->image }}" alt="Gallery 02"></div>
                    <div class="box"><img src="{{ $path . $college->image }}" alt="Gallery 03"></div> --}}
                </div>
            </div>
            <div class="page-title bg-gray-06 pt-8 pb-9">
                <div class="container">
                    <ul class="breadcrumb breadcrumb-style-03 mb-6">
                        <li class="breadcrumb-item caps"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item caps">{{ $college->type == 2 ? 'UNIVERSITY' : 'COLLEGE' }}</li>
                        <li class="breadcrumb-item"> {{ $college->name }}</li>
                    </ul>
                    <div class="explore-details-top d-flex flex-wrap flex-lg-nowrap">
                        <div class="store">
                            <div class="d-flex flex-wrap">
                                <h2 class="text-dark mr-3 mb-2 caps">{{ $college->name }}
                                </h2>
                            </div>
                            <ul class="list-inline store-meta d-flex flex-wrap align-items-center">
                                <li class="list-inline-item"><span
                                        class="badge badge-success d-inline-block mr-1">{{ $college->rating }}</span>
                                    <span>4 rating</span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="container">
                <div class="page-container">
                    <div class="row">
                        <div class="page-content col-xl-12 mb-8 mb-xl-0">
                            <div class="explore-details-container">
                                <div class="mb-9">
                                    ...
                                    <h4 class="font-size-md mb-4">Overview</h4>
                                    <div class="mb-7">
                                        {!! substr($college->description, 0, 10000) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row " style="display: flex; flex-direction: row; justify-content: center;">
                            <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                                <!-- <div class="mb-8"><img src="images/logo.png" alt="colleges"></div> -->
                                <h3>
                                    <span class="main-heading-color">Colleges</span>
                                    <span class="font-weight-light">Bangalore </span>
                                </h3>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-6 mb-lg-0 pl-lg-9">
                                ...
                                <ul class="list-group list-group-flush list-group-borderless">
                                    <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                        <a href="index.html" class="link-hover-secondary-primary">Home </a>
                                    </li>
                                    <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                        <a href="page-about.html" class="link-hover-secondary-primary">About Us</a>
                                    </li>
                                    <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                        <a href="page-contact.html" class="link-hover-secondary-primary">Contact
                                            Us</a>
                                    </li>
                                </ul>
                            </div>
       ...
       <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
        ...
        <img src="/images/Footer/telephone.png" alt="support" class="call-icon-in-footer"/> -->
                            <!-- <div>Support</div> -->
                            <!-- </a>
       </li> -->
                            ...
                            <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                                <div class="pl-0 pl-lg-9">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        we will inform you about newest directory and promotions
                                    </div>
       ...
       <div>
        ...
        >The Dir.</a
        >
        All Rights Resevered. Design by
        <a
        href="http://g5plus.net/"
        class="link-hover-dark-primary font-weight-semibold"
        >G5Theme</a
        >
       </div>
                                ...
                                <div class="col-lg-5 mb-3 mb-lg-0">
                                    <div>
                                        © 2024 Colleges Bangalore | Powered by <a href="https://howincloud.com/"
                                            class="link-hover-dark-primary font-weight-semibold" target="_blank">
                                            <!-- <span style="font-size: 14px; color: #fff; font-weight: 600;">Howin</span> -->
                                            <span style="font-size: 14px; color: black; font-weight: 600;">Howin</span>
                                            <span style="font-size: 12px; color: red; font-weight: 500;">CLOUD</span>

                                    </div>
                                </div>
                                <div class="back-top text-left text-lg-right gtf-back-to-top">
                                    <a href="#" class="link-hover-secondary-primary"><i
                                            class="fal fa-arrow-up"></i><span>Back To
                                            Top</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-register">
                            <form>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input id="username-rt" type="text" class="form-control"
                                        placeholder="Username">
                                </div>
                                <div class="form-group mb-2">
                                    <label for="email-01" class="sr-only">Email</label>
                                    <input id="email-01" type="text" class="form-control"
                                        placeholder="Email Address">
                                </div>
                                <div class="form-group mb-2">
                                    <label for="password-rt" class="sr-only">Username</label>
                                    <input id="password-rt" type="password" class="form-control"
                                        placeholder="Password">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-8">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label text-dark" for="check-term">You agree
                                            with our
                                    ...
                                    <ul class="dropdown-menu form-search-ajax" aria-labelledby="key-word-02">
                                        ...
                                        <li class="dropdown-item item">
                                            <a href="#" class="link-hover-dark-white">
                                                ...
                                                <span class="font-size-md">Healths &
                                                    Medicals</span>
                                            </a>
                                        </li>
                                        <li class="dropdown-item item">
        ...
        <script src="{{ $path }}newfront/vendors/jquery.min.js"></script>
        <script src="{{ $path }}newfront/vendors/jquery-ui/jquery-ui.min.js"></script>
        <script src="{{ $path }}newfront/vendors/popper/popper.js"></script>
        <script src="{{ $path }}newfront/vendors/bootstrap/js/bootstrap.js"></script>
        <script src="{{ $path }}newfront/vendors/hc-sticky/hc-sticky.js"></script>
        <script src="{{ $path }}newfront/vendors/isotope/isotope.pkgd.js"></script>
        <script src="{{ $path }}newfront/vendors/magnific-popup/jquery.magnific-popup.js"></script>
        <script src="{{ $path }}newfront/vendors/slick/slick.js"></script>
        <script src="{{ $path }}newfront/vendors/waypoints/jquery.waypoints.js"></script>
        <script src="{{ $path }}newfront/vendors/air-datepicker/js/datepicker.min.js"></script>
        <script src="{{ $path }}newfront/vendors/air-datepicker/js/i18n/datepicker.en.js"></script>
        <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiMIj9qJw-InawUWnu7kUK4GjDQ7dktMQ&amp;callback=initMap">
        </script>

        <script src="{{ $path }}newfront/js/app.js"></script>
        <svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1"
            ...
            <defs>
                ...
                <symbol id="icon-google-plus-symbol" viewBox="0 0 32 32">
                    ...
                    <path d="M27.077 4.923v-4.923h-2.462v4.923h-4.923v2.462h5.923v4.923h2.462v-4.923h5.923v-2.462z">
                    </path>
                </symbol>
