            ...
            <div class="nk-sidebar-content">
                <div class="nk-sidebar-menu" data-simplebar>
                    <ul class="nk-menu">
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('admin.viewCategories') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('admin.viewColleges') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                                        <em class="icon ni ni-building"></em>
                                    </span>
                                    <span class="nk-menu-text">College Management</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('plans')
                            <li class="nk-menu-item">
                                <a href="{{ route('admin.viewPlans')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                                    ...
                                    <span class="nk-menu-text">Plan Management</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('admin.viewReviews') }}" class="nk-menu-link">
                                    ...
                                    <span class="nk-menu-text">Review Management</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('admin.viewFAQ') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                                        <em class="fa-solid fa-question"></em>
                                    </span>
                                    <span class="nk-menu-text">College FAQ's</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('admin.viewLocations') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                        ...
                        @can('all_users')
                            <li class="nk-menu-item ">
                                <a href="{{ route('front.viewcontactform') }}" class="nk-menu-link">
                                    <span class="nk-menu-icon">
                                        <em class="icon ni ni-list"></em>
                                    </span>
                                    <span class="nk-menu-text">Contact Form</span>
                                </a>
                            </li>
                        @endcan
